...
INSERT INTO companies (id, name, tagline, location, email, website_url, description, overview, sector, image_url) VALUES
    (1, 'Razorpay', 'Payments for modern India', 'Bengaluru, Karna  taka', 'careers@razorpay-demo.example', 'https://razorpay.com', 'Full-stack payments and banking suite for Indian businesses.', 'High-growth fintech with strong campus hiring across SDE and analyst tracks.', 'Fintech', NULL), -- add image url here
